...
ui <- fluidPage(
    # 1. THEME MUST BE PLACED HERE AS A DIRECT ARGUMENT TO fluidPage
    theme = bs_theme(
        version = 5,
        bootswatch = "spacelab",
    ...
    # Dependencies & Custom CSS Head Elements
    shinyjs::useShinyjs(),
    ...
    tags$head(
      ...
      /* Grid styling for templates checkbox group */
      #templates .shiny-options-group {
        display: grid;
    ...
    tabsetPanel(
        ...
        # FIRST TAB: The Main Application
        tabPanel("startProject",
                 ...
                 div(
                     ...
                     div(
                         ...
                         # RIGHT COLUMN: Subfolders & Templates (8-wide)
                         div(
                             class = "col-lg-8 col-md-7",
                             
                             # Directory Framework Card
                             div(
                                 class = "card",
        ...
        # SECOND TAB: Structure Documentation
        tabPanel("Project Structure Options Explained",
                 fluidRow(
                     column(
                         width = 8, 
                         # offset = 2,
                         br(),
                         includeMarkdown("project_structure_explanation.Rmd")
                     )
                 )
        )
    )
