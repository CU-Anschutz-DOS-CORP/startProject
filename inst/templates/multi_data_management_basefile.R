...
############################################################################
# Customize your R template by either creating a .multi_data_management_basefile.R file 
# in your HOME directory or by  modifying the multi_data_management_basefile.R file 
# found in the templates folder of the library installation.
