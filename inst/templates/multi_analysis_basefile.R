...
############################################################################
# Customize your R template by either creating a .multi_analysis_basefile.R file 
# in your HOME directory or by  modifying the multi_analysis_basefile.R file 
